...
function verifica() {
	//parto dal presupposto che sia tutto ok, verifico semplicemente se va tutto bene,
	// appena ne trovo uno che non va bene esco. Non devo uscire se ho semaforo e checked insieme, 
	//oppure se non ho semaforo e non ho checked
	let ok = true
	let i = 0
	while (ok && i < _ImageDivs.length) {
